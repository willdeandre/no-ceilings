// components/top10overall-data.ts
// (Create this so you’re not duplicating data across components.)
import type { OverallProspect } from "@/components/top10overall";

export type BadgeType = 'shooter' | 'dimer' | 'athlete' | 'disruptor' | 'rim protector' | 'unlimited potential';

export const TOP_10_OVERALL: OverallProspect[] = [
  {
    id: "overall-1",
    rank: 1,
  ...
  },
  {
    ...
    article: {
      ...
      tag: "Nathan Grubel",
      href: "https://www.noceilingsnba.com/i/183372040/cameron-boozer-f-duke-69-250-lbs",
      img: "/big_three.png",
  ...
  },
  {
    ...
    bio: "Dybantsa is a scouts dream: lanky, fluid, athletic, and tenacious. His work ethic and desire to get better show clearly in his footwork and midrange scoring arsenal. He also uses his elite ability to get to the line to garner over 8 free throws per game. Dybantsa is not the perfect prospect, though, as he tends to play a step behind the beat, so to speak.",
    article: {
      title: "Cam Boozer, AJ Dybantsa, and Darryn Peterson are a Historic Prospect Trio",
      tag: "Nathan Grubel",
  ...
  },
  {
    ...
    bio: "Among this draft class, Brown Jr. may be the player with the highest delta between his ceiling and floor. At his best, Brown is a jumbo lead guard who can shoot, pass, and get to the hoop. The problem is that little of this is proven thus far. Brown Jr. has been a great playmaker, but he has put up tour dates shooting splits in all but one game. There is a lot to love here, and we will see if Brown Jr. can put it all together.",
    article: {
      title: "The Ice Cream Truck Class of Point Guards",
      tag: "Tyler Rucker",
  ...
  },
  {
    ...
    article: {
      title: "Darius Acuff Jr. | Prospect Spotlight",
      tag: "Stephen Gillaspie",
      href: "https://www.noceilingsnba.com/p/darius-acuff-jr-point-made-prospect",
      img: "/darius-acuff-jr-article.png",
      authorImg: "/stephen_gillaspie.png"
    },
